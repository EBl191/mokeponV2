...
// hydrokyonEnemigo.ataques.push(...HYDROKYON_ATAQUES)
...
// litomyseEnemigo.ataques.push(...LITOMYSE_ATAQUES)
...
// dracornitusEnemigo.ataques.push(...DRACORNITUS_ATAQUES)
...
// serpyctusEnemigo.ataques.push(...SERPYCTUS_ATAQUES)
...
// salamanderEnemigo.ataques.push(...SALAMANDER_ATAQUES)
...
// geoignisEnemigo.ataques.push(...GEOIGNIS_ATAQUES)
                ...
                .then(function ({enemigos}) {
                    ...
                    mokeponesEnemigos = enemigos.map(function(enemigo) {
                        ...
                        if (mokeponNombre === "Hydrokyon") {
                             mokeponEnemigo = new Mokepon("Hydrokyon", "./images/hydrokyon.png", 5, "./images/hydrokyon.png", 250, 40 )
                        } else if (mokeponNombre === "Litomyse") {
                             mokeponEnemigo = new Mokepon("Litomyse", "./images/litomyse.png", 5, "./images/litomyse.png", 100, 120)
                        } else if (mokeponNombre === "Dracornitus") {
                             mokeponEnemigo = new Mokepon("Dracornitus", "./images/dracornitus.png", 5, "./images/dracornitus.png", 130, 30)
                        } else if (mokeponNombre === "Serpyctus") {
                             mokeponEnemigo = new Mokepon("Serpyctus", "./images/serpyctus.png", 5, "./images/serpyctus.png", 200, 100)
                        } else if (mokeponNombre === "Salamander") {
                             mokeponEnemigo = new Mokepon("Salamander", "./images/salamander.png", 5, "./images/salamander.png", 10, 100)
                        } else {
                             mokeponEnemigo = new Mokepon("Geoignis", "./images/geoignis.png", 5, "./images/geoignis.png", 60, 60) 
                        }
